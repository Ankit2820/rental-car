         ...
         <div className="blog_details">
          ...
          <span className='blog_author'>
               ...
               <span className="d-flex align-items-center gap-1 section_description">
                ...
                <span className="d-flex align-items-center gap-1 section_description">
                    <i className="ri-calendar-line"></i> {blog.time}
                </span>
          </div>
         ...
         <div className="comment_list mt-5">
          ...
          <div className="comment_content">
            ...
            <p className="section_description">
             Lorem ipsum dolor sit amet consectetur adipisicing elit. Corporis, deserunt repellat? Tenetur itaque tempora facere magni reprehenderit minima autem, vel, earum eos rem nostrum maiores!
            </p>
