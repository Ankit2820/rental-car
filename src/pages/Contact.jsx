            ...
            <Container>
                <Row>
                    ...
                    <div className="contact_info">
                        ...
                        <p className="section_description mb-0">123 Anisabad, Patna, Bihar</p>
                        <div className="d-flex align-items-center gap-2">
                            <h6 className="fs-6 mb-0" margin>Phone:</h6>
                            <p className="section_description mb-0">+5587588997</p>
                        </div>
                        <div className="d-flex align-items-center gap-2">
